            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-3 mt-5 mt-md-0">
                    <div class="emergency-box">
                        <h2 class="d-flex align-items-center" >Emergencia</h2>
                        ...
                        <p>Evite llamar a este numero de no tratarse de una genuina emergencia. Para saber mas al respecto haz <a style="color:blue" href="#">click aqui</a> </p>
                    </div>
                </div>
                            ...
                            <button type="button" class="button gradient-bg" data-toggle="modal" id="btnModal" >Enviar </button>
                                        ...
                                        <div id="tvesModal" class="modalContainer">
                                            <div class="modal-content">                                                
                                                ...
                                                <strong>Dirección:</strong> Calle 17 No. 16A - 39 | Sincelejo, Sucre<br>
             ...
             <!-- Modal -->
            <div class="modal fade" id="example" tabindex="" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="">
